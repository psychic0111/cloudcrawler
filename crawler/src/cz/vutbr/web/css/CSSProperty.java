...
/**
 * Interface for definition of CSS properties. This
 * interface simplifies storing of values in maps, and
 * provides basic inheritance support. All implementations
 * of this interface should provide static value with
 * signature:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * to retrieve instance of property by string value. Since
 * enum classes provides this value automatically, it is
 * encouraged to use them. For make use of enums easier,
 * this contract should be followed: All values directly
 * represented in CSS style sheet such as:
 * <code>float: <b>left</b>;</code> or
 * <code>background-repeat: 
 * <b>repeat-x</b>;</code> should to converted to upper case
 * and all not alphanumeric characters should be converted
 * into underscores (<code>_</code>), for example
 * <code>REPEAT_X</code> All other values, with essentially
 * requires additional data, should broke enum standard and
 * use lower case letters only. This way it is guaranteed
 * that this value won't never be considered as a keyword.
 * 
 * @author kapy
 */
public interface CSSProperty {
	...
	/**
	 * CSS "inherit" keyword for retrieving instance by
	 * Translator object
	 */
	...
	/**
	 * Allows declarations of properties to inherit or to be
	 * inherited
	 * 
	 * @return <code>true</code> in case that this property
	 ...
	 * <code>inherit</code> value
	 * 
	 * @return <code>true</code>if value is
	 *         <code>INHERIT</code>, <code>false</code>
	 *         otherwise
	 */
	...
	/**
	 * Retrieves value of property of given class and text
	 * value
	 * 
	 * @author kapy
	 */
	public static class Translator {
		 ...
		 * @param value
		 *            Text value
		 * @return CSSProperty if found, <code>null</code>
		 *         elsewhere
		 */
		...
		public static final <T extends CSSProperty> T valueOf(Class<T> type, String value) {
			try {
				...
				/*
				 * throw new
				 * IllegalArgumentException("Unable to get: "
				 * + value + " for: " + type.getName(), e);
				 */
			}
		}
		 ...
		 * @return Should always return CSS instance. If
		 *         <code>null</code> is returned, something
		 *         is flawed.
		 */
	...
	public enum Azimuth implements CSSProperty {
		angle(""), LEFT_SIDE("left-side"), FAR_LEFT("far-left"), LEFT("left"), CENTER_LEFT("center-left"), CENTER("center"), CENTER_RIGHT("center-right"), RIGHT("right"), FAR_RIGHT("far-right"), RIGHT_SIDE("right-side"), BEHIND("behind"), LEFTWARDS(
				"leftwards"), RIGHTWARDS("rightwards"), INHERIT("inherit");
	...
	public enum BackgroundPosition implements CSSProperty {
		list_values(""), LEFT("left"), CENTER("center"), RIGHT("right"), TOP("top"), BOTTOM("bottom"), INHERIT("inherit");
	...
	public enum BorderStyle implements CSSProperty {
		component_values(""), NONE("none"), HIDDEN("hidden"), DOTTED("dotted"), DASHED("dashed"), SOLID("solid"), DOUBLE("double"), GROOVE("groove"), RIDGE("ridge"), INSET("inset"), OUTSET("outset"), INHERIT("inherit");
	...
	public enum Font implements CSSProperty {
		component_values(""), CAPTION("caption"), ICON("icon"), MENU("menu"), MESSAGE_BOX("message-box"), SMALL_CAPTION("small-caption"), STATUS_BAR("status-bar"), INHERIT("inherit");
	...
	public enum FontFamily implements CSSProperty {
		list_values("", ""), SERIF("serif", FONT_SERIF), SANS_SERIF("sans-serif", FONT_SANS_SERIF), CURSIVE("cursive", FONT_CURSIVE), FANTASY("fantasy", FONT_FANTASY), MONOSPACE("monospace", FONT_MONOSPACED), INHERIT("inherit", "");
	...
	public enum FontSize implements CSSProperty {
		percentage(""), length(""), XX_SMALL("xx-small"), X_SMALL("x-small"), SMALL("small"), MEDIUM("medium"), LARGE("large"), X_LARGE("x-large"), XX_LARGE("xx-large"), LARGER("larger"), SMALLER("smaller"), INHERIT("inherit");
	...
	public enum FontWeight implements CSSProperty {
		numeric_100("100"), numeric_200("200"), numeric_300("300"), numeric_400("400"), numeric_500("500"), numeric_600("600"), numeric_700("700"), numeric_800("800"), numeric_900("900"), NORMAL("normal"), BOLD("bold"), BOLDER("bolder"), LIGHTER("lighter"), INHERIT(
				"inherit");
	...
	public enum Cursor implements CSSProperty {
		AUTO("auto"), CROSSHAIR("crosshair"), DEFAULT("default"), POINTER("pointer"), MOVE("move"), E_RESIZE("e-resize"), NE_RESIZE("ne-resize"), NW_RESIZE("nw-resize"), N_RESIZE("n-resize"), SE_RESIZE("se-resize"), SW_RESIZE("sw-resize"), S_RESIZE("s-resize"), W_RESIZE(
				"w-resize"), TEXT("text"), WAIT("wait"), PROGRESS("progress"), HELP("help"), INHERIT("inherit");
	...
	public enum Display implements CSSProperty {
		INLINE("inline"), BLOCK("block"), LIST_ITEM("list-item"), RUN_IN("run-in"), INLINE_BLOCK("inline-block"), TABLE("table"), INLINE_TABLE("inline-table"), TABLE_ROW_GROUP("table-row-group"), TABLE_HEADER_GROUP("table-header-group"), TABLE_FOOTER_GROUP(
				"table-footer-group"), TABLE_ROW("table-row"), TABLE_COLUMN_GROUP("table-column-group"), TABLE_COLUMN("table-column"), TABLE_CELL("table-cell"), TABLE_CAPTION("table-caption"), NONE("none"), INHERIT("inherit");
	...
	public enum ListStyleType implements CSSProperty {
		DISC("disc"), CIRCLE("circle"), SQUARE("square"), DECIMAL("decimal"), DECIMAL_LEADING_ZERO("decimal-leading-zero"), LOWER_ROMAN("lower-roman"), UPPER_ROMAN("upper-roman"), LOWER_GREEK("lower-greek"), LOWER_LATIN("lower-latin"), UPPER_LATN(
				"upper-latin"), ARMENIAN("armenian"), GEORGIAN("georgian"), LOWER_ALPHA("lower-alpha"), UPPER_ALPHA("upper-alpha"), NONE("none"), INHERIT("inherit");
	...
	public enum OutlineStyle implements CSSProperty {
		NONE("none"), DOTTED("dotted"), DASHED("dashed"), SOLID("solid"), DOUBLE("double"), GROOVE("groove"), RIDGE("ridge"), INSET("inset"), OUTSET("outset"), HIDDEN("hidden"), INHERIT("inherit");
	...
	public enum SpeechRate implements CSSProperty {
		number(""), X_SLOW("x-slow"), SLOW("slow"), MEDIUM("medium"), FAST("fast"), X_FAST("x-fast"), FASTER("faster"), SLOWER("slower"), INHERIT("inherit");
	...
	public enum TextAlign implements CSSProperty {
		BY_DIRECTION("by-direction"), LEFT("left"), RIGHT("right"), CENTER("center"), JUSTIFY("justify"), INHERIT("inherit");
	...
	public enum TextDecoration implements CSSProperty {
		list_values(""), UNDERLINE("underline"), OVERLINE("overline"), BLINK("blink"), LINE_THROUGH("line-through"), NONE("none"), INHERIT("inherit");
	...
	public enum VerticalAlign implements CSSProperty {
		length(""), percentage(""), BASELINE("baseline"), SUB("sub"), SUPER("super"), TOP("top"), TEXT_TOP("text-top"), MIDDLE("middle"), BOTTOM("bottom"), TEXT_BOTTOM("text-bottom"), INHERIT("inherit");
	...
	public enum Volume implements CSSProperty {
		number(""), percentage(""), SILENT("silent"), X_SOFT("x-soft"), SOFT("soft"), MEDIUM("medium"), LOUD("loud"), X_LOUD("x-loud"), INHERIT("inherit");
	...
	/**
	 * A generic property used for all the properties not
	 * supported by another implementation.
	 */
	public class GenericCSSPropertyProxy implements CSSProperty {
		 ...
		 * GenericCSSPropertyProxy. This method simulates
		 * the method valueOf(String) of the other CSS
		 * attributes that are implmented as enums.
		 * 
		 * @param value
		 *            the property value.
		 * @return a new insance that contains the property
		 *         value.
		 */
