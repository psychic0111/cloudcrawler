...
public class QuartzManager {
	 ...
	 */
	public static void addJob(String jobName, String jobClass, String time,Map dataMap) {
		try {
	...
	public static boolean hasJob(String jobName){
		try {
			return (gSchedulerFactory.getScheduler().getTrigger(jobName, TRIGGER_GROUP_NAME)!=null?true:false);
	...
	public static void modifyJobTime(String jobName, String time) {
		try {
			...
			if (!oldTime.equalsIgnoreCase(time)) {
				...
				addJob(jobName, jobClass, time,jobDetail.getJobDataMap());
			}
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException(e);
