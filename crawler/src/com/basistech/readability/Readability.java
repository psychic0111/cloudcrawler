...
public class Readability {
	...
	private void prepDocument() {
		...
		if (frames.size() > 0) {
			LOG
					.error("Frames. Can't deal. Write code later to look at URLs and fetch");
			impossible = true;
			return;
		}
	...
	private void incrementContentScore(Element node, double score) {
		node.attr("data-readability.contentScore", Double
				.toString(getContentScore(node) + score));
	}
	...
	private URI findBaseUrl0(String stringUrl) throws URISyntaxException {
		...
		URI baseUrl = new URI(url.getScheme(), url.getAuthority(), url
				.getPath(), null, null);
	...
	public void processDocument1(String content, String url)
