	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="name" type="text" name="name" style="width: 292px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<select id="categoryId" class="inputTxt1" style="width: 300px;"  name="categoryId" >
		...
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="urlRule" type="text" name="urlRule" style="width: 292px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="titleFilterChars" type="text" name="titleFilterChars" style="width: 292px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="titleRules" type="text" name="titleRules" style="width: 292px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="publishTime" type="text" name="publishTime" style="width: 292px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4_temp">
				<input id="author" type="text" name="author" style="width: 150px;" class="inputTxt1" />
			</td>
			<td class="TD_Bgcolor3" width="25%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4_temp">
				<input id="srcSites" type="text" name="srcSites" style="width: 150px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4_temp">
				<input id="relationRule" type="text" name="relationRule" style="width: 150px;" class="inputTxt1" />
			</td>
			<td class="TD_Bgcolor3" width="25%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4_temp">
				<input id="pageRules" type="text" name="pageRules" style="width: 150px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4_temp">
				<input id="views" type="text" name="views" style="width: 150px;" class="inputTxt1" />
			</td>
			<td class="TD_Bgcolor3" width="25%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4_temp">
				<input id="comments" type="text" name="comments" style="width: 150px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="contentRules" type="text" name="contentRules" style="width: 292px;" class="inputTxt1" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
