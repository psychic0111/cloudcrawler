...
<form id="editSiteProxyForm" method="post" 	action="${pageContext.request.contextPath}/siteProxy/editDo.do">
	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="label">操&nbsp;&nbsp;作&nbsp;人: <a href="javascript:void(0)" onclick="toolTip(this,'定义代理操作人，最后一个操作该代理的人')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="label">操作时间: <a href="javascript:void(0)" onclick="toolTip(this,'定义代理操作时间，最后一次操作该代理的时间')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
