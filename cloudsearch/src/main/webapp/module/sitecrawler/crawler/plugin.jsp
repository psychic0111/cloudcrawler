...
<table border=0 cellpadding="0"  cellspacing="0" width="100%;" class=".tbody">
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">是否下载图片: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫是否下载图片，若是，则下载文章中的图片，否则，不下载文章中的图片')">[?]</a></span>
		</td>
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">最小图片大小: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫最小图片大小，图片大小大于等于该尺寸的时候，对该图片进行下载，否则该图片将被视为广告图片，不予下载')">[?]</a></span>
		</td>
	...
	<tr  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">图片存储路径: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫图片存储路径，爬虫下载图片以后，将图片保存在该路径下')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">数据存储方式: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据保存方式，目前为保存在数据库中')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr class="crawlerShow" height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">数据库&nbsp;&nbsp;&nbsp;类型: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库类型，当数据存储方式是数据库存储时，您要存放的数据库类型')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr class="crawlerShow"  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">服务器&nbsp;&nbsp;&nbsp;地址: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库服务器IP，当数据存储方式是数据库存储时，您要使用的数据库所在的服务器的IP')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr class="crawlerShow"  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">端&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;口&nbsp;&nbsp;&nbsp;&nbsp;号: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库服务器断开，当数据存储方式是数据库存储时，您要使用的数据库的访问端口')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr class="crawlerShow"  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;&nbsp;名: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库访问用户名，当数据存储方式是数据库存储时，您要使用的数据库的用户名')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr class="crawlerShow"  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库访问密码，当数据存储方式是数据库存储时，您要使用的数据库的密码')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
			<input id="dbpassword" type="password" name="dbpassword" value="${dataBase.dbpassword }" style="width: 300px;" class="inputTxt1"  />
		</td>
	</tr>
	<tr class="crawlerShow"  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label" >数&nbsp;&nbsp;据&nbsp;&nbsp;库&nbsp;&nbsp;名: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库，当数据存储方式是数据库存储时，您要使用的数据库的名称')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
	...
	<tr class="crawlerShow"  height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label" >数&nbsp;&nbsp;据&nbsp;&nbsp;库&nbsp;&nbsp;表: <a href="javascript:void(0)" onclick="toolTip(this,'定义爬虫数据库中的表，当数据存储方式是数据库存储时，您要使用的数据库中的表名称')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="80%" >
