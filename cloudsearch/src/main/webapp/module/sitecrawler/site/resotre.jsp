...
<form id="restoreSiteForm" method="post" 	action="${pageContext.request.contextPath}/site/restore.do"  enctype="multipart/form-data">
	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;"  class=".tbody">
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">文件路径: <a href="javascript:void(0)" onclick="toolTip(this,'定义站点分类名称')">[?]</a></span>
			</td>
	...
	<div class="function2">
		<input name="" type="button" class="botton_style3"  onclick="checkFileType();" id="submitBtn" value="导入" />
