	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;"  class=".tbody">
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="30%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">任&nbsp;&nbsp;&nbsp;&nbsp;务&nbsp;&nbsp;&nbsp;&nbsp;名&nbsp;&nbsp;&nbsp;&nbsp;称: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务名称，为任务起一个有意义的名称')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
				<input id="taskName" type="text" name="taskName" style="width: 190px;" class="inputTxt1" maxlength="100" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="30%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">执&nbsp;&nbsp;&nbsp;&nbsp;行&nbsp;&nbsp;&nbsp;&nbsp;频&nbsp;&nbsp;&nbsp;&nbsp;率: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务执行频率，指定该任务运行的频率')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
		...
		<tr id="weekShow" height="30px;" style="display: none;">
			<td class="TD_Bgcolor3" width="30%" >
			...
			<td class="TD_Bgcolor4" width="30%" >
				<input type="checkbox" id = "monday" name = "weekDays" value = "2"/>一
				<input type="checkbox" id = "tuesday" name = "weekDays" value = "3"/>二
				<input type="checkbox" id = "thirsday" name = "weekDays" value = "4"/>三
				<input type="checkbox" id = "fourday" name = "weekDays" value = "5"/>四
				<input type="checkbox" id = "friday" name = "weekDays" value = "6"/>五
				<input type="checkbox" id = "saturday" name = "weekDays" value = "7"/>六
				<input type="checkbox" id = "sunday" name = "weekDays" value = "1"/>日
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="30%" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="30%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">执&nbsp;&nbsp;&nbsp;&nbsp;行&nbsp;&nbsp;&nbsp;&nbsp;间&nbsp;&nbsp;&nbsp;&nbsp;隔: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务执行间隔，指定该任务的执行间隔')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
				<input id="click" type="text" name="click" style="width: 100px;" value="1" class="inputTxt1" maxlength="100" />
				<select id="clickType" name="clickType" class="inputTxt1" style="width: 90px;height:25px;">
		...
		<tr height="30px;">
			<td class="TD_Bgcolor3" width="30%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">是&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;&nbsp;&nbsp;启&nbsp;&nbsp;&nbsp;&nbsp;用: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务是否启用，若启用，则该任务会被执行；否则，该任务不执行')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
				<select id="isUse" name="isUse" class="inputTxt1" style="width: 200px;height:30px;">
		...
		<tr height="30px;">
			<td class="TD_Bgcolor3" width="30%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">采&nbsp;&nbsp;&nbsp;&nbsp;集&nbsp;&nbsp;&nbsp;&nbsp;目&nbsp;&nbsp;&nbsp;&nbsp;标: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务采集目标，指定该任务采集的站点')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
				<select id="isAllSites" name="isAllSites" class="inputTxt1" onchange="changeBlock(this);" style="width: 200px;height:30px;">
		...
		<tr height="30px;" class="taskHide">
			<td class="TD_Bgcolor3" width="28%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">采集分类下的站点: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务采集分类，该任务会采集哪些分类下的站点')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
		...
		<tr height="30px;" class="taskHide">
			<td class="TD_Bgcolor3" width="30%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">采&nbsp;&nbsp;&nbsp;&nbsp;集&nbsp;&nbsp;&nbsp;&nbsp;站&nbsp;&nbsp;&nbsp;&nbsp;点: <a href="javascript:void(0)" onclick="toolTip(this,'定义任务采集站点，指定该任务采集的站点')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="70%" >
...
<form id="siteCategoryForm" style="display: none;" method="post" 	action="${pageContext.request.contextPath}/task/doAdd.do">
	<div style="height: 500px;overflow:auto;">
		<table id="siteCategoryTable" border=0 cellpadding="0" cellspacing="0" width="100%;"  class=".tbody">
