	...
	<table  style=" border:#c1c7cb 1px solid; margin-top:10px;"  cellpadding="0" cellspacing="0" width="100%;"  class=".tbody">
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor1" width="25%" style=" border-bottom:#c1c7cb 1px solid;border-right:#c1c7cb 1px solid;" >
				<span class="txt_color2" style="margin-left: 25px;"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">全网采集状态: <a href="javascript:void(0)" onclick="toolTip(this,'搜索引擎当前的采集状态......')">[?]</a></span>
			</td>
