	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;"  class=".tbody">
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">名&nbsp;&nbsp;&nbsp;称: <a href="javascript:void(0)" onclick="toolTip(this,'定义监控词名称')">[?]</a></span>
			</td>
		...
		<tr height="30px;">
			<td class="TD_Bgcolor3" width="25%" valign="top">
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">监控词: <a href="javascript:void(0)" onclick="toolTip(this,'定义监控词')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%">
				<table style="width:100%;height:100%;">
					<tr>
						<td valign="bottom" style="border-width:0px;text-align:left;">
							<textarea id="words" name="words" rows="5" cols="31" class="textarea" minlength=2 maxlength=200></textarea>
						</td>
						<td valign="bottom" style="border-width:0px;text-align:left;">
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">是否启用: <a href="javascript:void(0)" onclick="toolTip(this,'定义监控词名称')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
