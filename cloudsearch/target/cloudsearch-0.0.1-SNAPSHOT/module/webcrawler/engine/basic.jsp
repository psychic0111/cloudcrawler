...
<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="15%" style="padding-left:0px;">
			<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">搜索引擎名称: <a href="javascript:void(0)" onclick="toolTip(this,'定义您要采集的搜索引擎的名称')">[?]</a></span>
		</td>
		...
		<td class="TD_Bgcolor3" width="15%" >
			<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">代&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码: <a href="javascript:void(0)" onclick="toolTip(this,'定义您要采集的搜索引擎代码，为数据交互是使用')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="35%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" >
			<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">访&nbsp;&nbsp;问&nbsp;&nbsp;地&nbsp;&nbsp;址: <a href="javascript:void(0)" onclick="toolTip(this,'定义您要采集搜索引擎的入口地址')">[?]</a></span>
		</td>
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="15%" >
			<span class="label">内&nbsp;&nbsp;容&nbsp;&nbsp;类&nbsp;&nbsp;型: <a href="javascript:void(0)" onclick="toolTip(this,'定义您要采集搜索引擎的内容的类型')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="35%" >
		...
		<td class="TD_Bgcolor3" width="15%" >
			<span class="label">媒&nbsp;&nbsp;体&nbsp;&nbsp;类&nbsp;&nbsp;型: <a href="javascript:void(0)" onclick="toolTip(this,'定义您要采集搜索引擎所属的媒体类型')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="35%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="15%" >
			<span class="label">是&nbsp;&nbsp;否&nbsp;&nbsp;启&nbsp;&nbsp;用: <a href="javascript:void(0)" onclick="toolTip(this,'定义该搜索引擎是否处于使用状态')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="35%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="15%" valign="top" >
			<img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /><span class="label">抓&nbsp;&nbsp;取&nbsp;&nbsp;页&nbsp;&nbsp;数: <a href="javascript:void(0)" onclick="toolTip(this,'定义该搜索引擎在采集数据的过程中，采集该搜索引擎的第前多少页')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="35%" >
