	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">代理名称: <a href="javascript:void(0)" onclick="toolTip(this,'例如：新浪')">[?]</a></span>
			</td>
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">IP&nbsp;&nbsp;地&nbsp;址: <a href="javascript:void(0)" onclick="toolTip(this,'例如：192.168.1.159')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">端&nbsp;&nbsp;口&nbsp;号: <a href="javascript:void(0)" onclick="toolTip(this,'例如：8888')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="label">用&nbsp;&nbsp;户&nbsp;名: <a href="javascript:void(0)" onclick="toolTip(this,'例如：zhangsan')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
				<span class="label">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码: <a href="javascript:void(0)" onclick="toolTip(this,'例如：123456')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" valign="top" rowspan="2">
				<span class="label">代理描述: <a href="javascript:void(0)" onclick="toolTip(this,'例如：我的代理描述')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" >
