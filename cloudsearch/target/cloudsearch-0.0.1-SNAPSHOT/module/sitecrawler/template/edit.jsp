	...
	<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="name" type="text" name="name" value="${template.name }" style="width: 292px;" class="inputTxt1" maxlength="100" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" >
		...
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="urlRule" type="text" name="urlRule" value="${template.urlRule}" style="width: 292px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#urlRule").val('${template.urlRule}');
				</script>
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="titleFilterChars" type="text" name="titleFilterChars" value="${template.titleFilterChars}"  style="width: 292px;" class="inputTxt1" maxlength="100" />
			</td>
		</tr>
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%">
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="titleRules" type="text" name="titleRules" value=""  style="width: 292px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#titleRules").val('${template.titleRules}');
				</script>
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="publishTime" type="text" name="publishTime" value="" style="width: 292px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#publishTime").val("${template.publishTime}");
				</script>
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="40%" >
				<input id="author" type="text" name="author" value="" style="width: 150px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#author").val('${template.author}');
				</script>
			</td>
			...
			<td class="TD_Bgcolor4" width="40%" >
				<input id="srcSites" type="text"  name="srcSites" value="" style="width: 150px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#srcSites").val('${template.srcSites}');
				</script>
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="40%" >
				<input id="relationRule" type="text" name="relationRule" value="" style="width: 150px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#relationRule").val('${template.relationRule}');
				</script>
			</td>
			<td class="TD_Bgcolor3" width="20%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4" width="40%" >
				<input id="pageRules" type="text" name="pageRules" value=""  style="width: 150px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#pageRules").val('${template.pageRules}');
				</script>
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="40%" >
				<input id="views" type="text" name="views" value="" style="width: 150px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#views").val('${template.views}');
				</script>
			</td>
			<td class="TD_Bgcolor3" width="20%" style="padding-left:0px;">
			...
			<td class="TD_Bgcolor4" width="40%" >
				<input id="comments" type="text" name="comments" value="" style="width: 150px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#comments").val('${template.comments}');
				</script>
			</td>
		</tr>
		<tr height="30px;" >
			...
			<td class="TD_Bgcolor4" width="80%" colspan="3">
				<input id="contentRules" type="text" name="contentRules" value="" style="width: 292px;" class="inputTxt1" maxlength="100" />
				<script>
					$("#contentRules").val('${template.contentRules}');
				</script>
			</td>
		</tr>
		<tr height="30px;" >
