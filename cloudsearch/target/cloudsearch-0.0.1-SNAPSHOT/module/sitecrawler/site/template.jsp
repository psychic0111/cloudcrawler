...
<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
	...
	<td class="TD_Bgcolor4" width="80%" colspan="3">
		<input id="nameTempleteId" type="text" name="name" style="width: 140px;" class="inputTxt1" maxlength="100" />
	</td>
	</tr>
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
	...
	<td class="TD_Bgcolor4" width="80%" colspan="3">
		<select id="fristLevel" class="inputTxt1" style="width: 150px;"  name="categoryId" >
	...
	<tr height="30px;" >
		...
		<td class="TD_Bgcolor4" width="80%" colspan="3">
			<input id="testUrl" type="text" name="testUrl" style="width: 292px;" class="inputTxt1" maxlength="100" /><input name="" style="margin-left:30px;" type="button" class="botton_style3" onclick="ruleTest()" value="测试"  />
		</td>
	</tr>
</table>
