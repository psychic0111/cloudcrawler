...
<table border=0 cellpadding="0" cellspacing="0" width="100%;" class=".tbody">
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">爬&nbsp;&nbsp;虫&nbsp;&nbsp;名&nbsp;&nbsp;称: <a href="javascript:void(0)" onclick="toolTip(this,'为爬虫定义一个名称')">[?]</a></span>
		</td>
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">访&nbsp;&nbsp;问&nbsp;&nbsp;路&nbsp;&nbsp;径: <a href="javascript:void(0)" onclick="toolTip(this,'爬虫的访问路径')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
				<span class="txt_color2"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">爬&nbsp;&nbsp;虫&nbsp;&nbsp;代&nbsp;&nbsp;码: <a href="javascript:void(0)" onclick="toolTip(this,'为爬虫定义一个编码，为数据交互是使用')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">采&nbsp;&nbsp;集&nbsp;&nbsp;线&nbsp;&nbsp;程: <a href="javascript:void(0)" onclick="toolTip(this,'爬虫在采集数据的过程中，每一个爬虫可以同时开启的线程数')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">下&nbsp;&nbsp;载&nbsp;&nbsp;线&nbsp;&nbsp;程: <a href="javascript:void(0)" onclick="toolTip(this,'爬虫在下载图片的过程中，每一个爬虫可以同时开启的线程数据')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">单&nbsp;&nbsp;站点&nbsp;线程: <a href="javascript:void(0)" onclick="toolTip(this,'每一个站点中，采集数据和下载图片的总线程个数')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" valign="top" >
			<span class="label">是否存储快照: <a href="javascript:void(0)" onclick="toolTip(this,'是否存储网页的快照')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">使&nbsp;&nbsp;用&nbsp;&nbsp;状&nbsp;&nbsp;态: <a href="javascript:void(0)" onclick="toolTip(this,'该爬虫的使用状态，是否可用')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
	...
	<tr height="30px;" >
		<td class="TD_Bgcolor3" width="25%" >
			<span class="label">爬&nbsp;&nbsp;虫&nbsp;&nbsp;类&nbsp;&nbsp;型: <a href="javascript:void(0)" onclick="toolTip(this,'该爬虫的类型，主要是指该爬虫要针对那些数据进行采集')">[?]</a></span>
		</td>
		<td class="TD_Bgcolor4" width="70%" >
