	...
	<table  style=" border:#c1c7cb 1px solid; margin-top:10px;"  cellpadding="0" cellspacing="0" width="100%;"  class=".tbody">
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" style=" border-bottom:#c1c7cb 1px solid;border-right:#c1c7cb 1px solid;"  >
				<span class="txt_color2" style="margin-left: 25px;"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">网络连接尝试次数: <a href="javascript:void(0)" onclick="toolTip(this,'定义网络连接尝试次数')">[?]</a></span>
			</td>
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor3" width="25%" style=" border-bottom:#c1c7cb 1px solid;border-right:#c1c7cb 1px solid;" >
				<span class="txt_color2" style="margin-left: 25px;"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">网络连接超时时间: <a href="javascript:void(0)" onclick="toolTip(this,'定义网络连接超时时间')">[?]</a></span>
			</td>
			<td class="TD_Bgcolor4" width="80%" style=" border-bottom:#c1c7cb 1px solid;" >
		...
		<tr height="30px;" >
			<td class="TD_Bgcolor1" width="25%" style=" border-right:#c1c7cb 1px solid;" >
				<span class="txt_color2" style="margin-left: 25px;"><img src="${pageContext.request.contextPath}/images/star2.png" width="15" height="16" /></span><span class="label">跳&nbsp;&nbsp;&nbsp;&nbsp;转&nbsp;&nbsp;&nbsp;&nbsp;次&nbsp;&nbsp;&nbsp;&nbsp;数: <a href="javascript:void(0)" onclick="toolTip(this,'定义跳转次数')">[?]</a></span>
			</td>
