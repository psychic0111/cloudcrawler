...
<!--header Begin-->
<div class="header">
  <div class="left"><img src="${pageContext.request.contextPath}/images/logo.png" height="50"/></div>
...
<div class="mainer" id="mainer"  > 
  ...
  <div class="menus">
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="c_td"><img src="${pageContext.request.contextPath}/images/index.png"/><a href="javascript:void(0)" onclick="navto(this,'${pageContext.request.contextPath}/nav/navTo.do?id=indexMgr')">站点采集</a></td>
        ...
        --><td class="c_td"><img src="${pageContext.request.contextPath}/images/mag.png"/><a href="javascript:void(0)" onclick="navto(this,'${pageContext.request.contextPath}/nav/navTo.do?id=index')">爬虫管理</a></td>
  ...
  <div class="mainer_content" > 
    ...
    <div class="mainer_left">
      <div class="submenu">
	      <ul>
		      <li class="title"><img src="${pageContext.request.contextPath}/images/index.png"/>站点配置</li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/siteCategory/siteCategory.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">站点分类</a></li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/site/site.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">站点管理</a></li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/region/region.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">区域管理</a></li>
	      </ul>
      </div>
      <div class="submenu">
	      <ul>
	      	  <li class="title"><img src="${pageContext.request.contextPath}/images/index.png"/>采集模板</li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/templateCategory/templateCategory.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">模板分类</a></li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/template/template.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">模板管理</a></li>
	      </ul>
      </div>
      <div class="submenu">
	      <ul>
	      	  <li class="title"><img src="${pageContext.request.contextPath}/images/index.png"/>网络设置</li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/netParam/netParam.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">网络连接参数</a></li>
		      <li class="other" style="cursor:pointer;" onclick="linkto(this,'/siteProxy/siteProxy.do')"><img src="${pageContext.request.contextPath}/images/arrow.png"/><a href="javascript:void(0)">代理服务器设置</a></li>
	      </ul>
      </div>
    </div>
    <!--mainer_left End--> 
    ...
    <div class="mainer_right"> 
      <!--nav Begin-->
      <div class="nav">
        <div class="left"><strong>你的位置：</strong><span id="f_nav_path">首页 </span>&gt;&nbsp;<span id="s_nav_path">索引管理</span>&gt;&nbsp;<span id="c_nav_path" class="txt_color1">索引字段设置</span></div>
				...
				<div class="contents" id="dialogDivContents" style="z-index:1002">
					<div class="float_frame_title"  id="dialogDivTitle" style="z-index:1002">
						...
						<div class="right" id="dialogDivTitleClose" style="z-index:1002">
							<a href="javascript:;"><img src="${pageContext.request.contextPath}/images/cancel.png" onclick="closeDg()" width="16" height="16" /> </a>
						</div>
						<div class="clear"></div>
					</div>
